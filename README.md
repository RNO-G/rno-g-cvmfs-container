...
make podman-run  # an example of how to run it, mounting $RNO_G_WORKSPACE to /rno-g if it exists.


# Usage with docker

make docker  # generate the image
make docker-run  # an example of how to run it, mounting $RNO_G_WORKSPACE to /rno-g if it exists.
